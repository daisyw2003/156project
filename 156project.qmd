...
# Define a function for DR estimation
doubly_robust_estimation <- function(outcome_var) {
  ...
  # Return model summary with heteroskedasticity-robust standard errors
  coeftest(dr_model, vcov = vcovHC(dr_model, type = "HC1"))
}

### Step 3: Apply DR Estimation for All Dependent Variables

# List of dependent variables for DR estimation
dependent_vars <- c(
...
dr_results <- lapply(dependent_vars, doubly_robust_estimation)
...
### Step 4: Display DR Estimation Results
dr_results
